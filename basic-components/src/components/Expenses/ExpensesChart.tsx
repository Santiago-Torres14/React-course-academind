...
import {DataPoint, ExpenseData} from "../../utils/Interfaces";
import {Chart} from "../Chart/Chart";

export const ExpensesChart: React.FC<{expenses: ExpenseData[]}> = ({expenses}) => {
    ...
    expenses.forEach((value) => {
        chartDataPoints[value.date.getMonth()].value += value.amount;
    });
